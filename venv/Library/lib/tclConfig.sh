...
# installed.
TCL_PREFIX='E:/papx/end_to_end_ml/ml_bets_beta/ml_bets_beta/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/papx/end_to_end_ml/ml_bets_beta/ml_bets_beta/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/papx/end_to_end_ml/ml_bets_beta/ml_bets_beta/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/papx/end_to_end_ml/ml_bets_beta/ml_bets_beta/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/papx/end_to_end_ml/ml_bets_beta/ml_bets_beta/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/papx/end_to_end_ml/ml_bets_beta/ml_bets_beta/venv\Library\lib\tclstub86.lib'
